    ...
    public partial class QlyPhong : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            if (them == true)
            {
                ...
                {
                    phong.ThemPhong(txtMaPT.Text, txtTenPT.Text, txtTT.Text, txtMoTa.Text, comboBox1.SelectedValue.ToString());
            ...
            {
                phong.SuaPhong(txtMaPT.Text, txtTenPT.Text, txtTT.Text, txtMoTa.Text, comboBox1.SelectedValue.ToString());
            }
            listView1.Items.Clear();
            HienThiDSPhong();
            Setbtn(true);
